...
class KittiDataset(Dataset):
    def __init__(self, info_path, root_path, num_point_features, target_assigner, feature_map_size, prep_func):
    ...
    def __getitem__(self, idx):
        return _read_and_prep_v9(info=self._kitti_infos[idx],
