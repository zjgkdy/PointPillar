...
def build(model_cfg: second_pb2.VoxelNet, voxel_generator, target_assigner) -> VoxelNet:
    ...
    # 定义损失函数
    loss_norm_type_dict = {0: LossNormType.NormByNumExamples,
    ...
    # 定义网络结构
    net = VoxelNet(dense_shape,
                   num_class=model_cfg.num_class,  # 1
                   vfe_class_name=model_cfg.voxel_feature_extractor.module_class_name,  # PillarFeatureNet
                   vfe_num_filters=vfe_num_filters,  # [64]
                   middle_class_name=model_cfg.middle_feature_extractor.module_class_name,  # PointPillarsScatter
                   ...
                   rpn_class_name=model_cfg.rpn.module_class_name,  # RPN
                   ...
                   rpn_upsample_strides=list(model_cfg.rpn.upsample_strides),  # [1, 2, 4]
